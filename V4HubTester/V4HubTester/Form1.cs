...
namespace V4HubTester
{
    public partial class Form1 : Form
    {
        ...
        public Form1(HubDBContext db) //TODO add mainForm
        {
            InitializeComponent();
            this.db = db;
        ...
        private void serialPort_DataReceived(object sender, SerialDataReceivedEventArgs e)
        {
            ...
            switch (index)
            {
                case 1:
                    ...
                    break;
                //case 2:
                //    processData(serialPort2, textBox2, label21, label20);
                //    break;
                //case 3:
                //    processData(serialPort3, textBox3, label31, label30);
                //    break;
                //case 4:
                //    processData(serialPort4, textBox4, label41, label40);
                //    break;
                default:
                    return;
            }
        ...
        private void processData(SerialPort serialPort, RichTextBox textBox, Label tutorial, Label info)
        {
            // get pos (equivalent to position)
            int pos = Array.IndexOf(ports, serialPort.PortName);
            int num = serialPort.BytesToRead;      //buffer length
            byte[] received_buf = new byte[num];    //create a byte[] to accept the data which is read from buffer

            serialPort.Read(received_buf, 0, num);   //read serial port buffer

            sb.Clear();     //clean the stringbuilder

            sb.Append(Encoding.ASCII.GetString(received_buf));  //parse the buffer as ASCII
            try
            {
                ...
                Invoke((EventHandler)(delegate
                {
                    ...
                    var text = textBox.Text.Substring(states["hub" + pos]["index"]);
                    switch (states["hub" + pos]["phase"])
                    {
                        case 0: // hub is launching, monitoring when it's done.
                            ...
                            states["hub" + pos]["index"] = textBox.Text.Length;
                        ...
                        case 4:// hub is waiting for user input, monitoring where is the end of the test report
                            ...
                            hubObj.KeyUp = textBox.Text.IndexOf("[ KeyUp   ] has been detected.") != -1;
                            hubObj.KeyDown = textBox.Text.IndexOf("[ KeyDown ] has been detected.") != -1;
                            hubObj.KeyPwr = textBox.Text.IndexOf("[ KeyPwr ] has been detected.") != -1;
        ...
        //        serialPort3.Close();
        //        serialPort4.Close();
        //        // update textBox on another thread
        ...
        //            textBox2.Text = "";
        //        }));
        //        textBox3.Invoke(new MethodInvoker(() =>
        //        {
        //            textBox3.Text = "";
        //        }));
        //        textBox4.Invoke(new MethodInvoker(() =>
        //        {
        //            textBox4.Text = "";
        //        }));
        //    }
        ...
        //    button13.BackgroundImage = global::V4HubTester.Properties.Resources.connect;
